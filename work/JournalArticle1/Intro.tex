...
The counterpart to refinement of machines, is extension of contexts. This allows a user to build upon pre-existing contexts using the \emph{EXTENDS} clause.  
