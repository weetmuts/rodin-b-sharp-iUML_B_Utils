		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatemachineAccess().getCommentAssignment_6_1(), "rule__Statemachine__CommentAssignment_6_1");
					put(grammarAccess.getStatemachineAccess().getNodesAssignment_7_1(), "rule__Statemachine__NodesAssignment_7_1");
					put(grammarAccess.getStatemachineAccess().getNodesAssignment_7_2_1(), "rule__Statemachine__NodesAssignment_7_2_1");
					put(grammarAccess.getStatemachineAccess().getTransitionsAssignment_8_1(), "rule__Statemachine__TransitionsAssignment_8_1");
					put(grammarAccess.getStatemachineAccess().getTransitionsAssignment_8_2(), "rule__Statemachine__TransitionsAssignment_8_2");
					...
					put(grammarAccess.getStateAccess().getInvariantsAssignment_3_1(), "rule__State__InvariantsAssignment_3_1");
					put(grammarAccess.getStateAccess().getInvariantsAssignment_3_2(), "rule__State__InvariantsAssignment_3_2");
