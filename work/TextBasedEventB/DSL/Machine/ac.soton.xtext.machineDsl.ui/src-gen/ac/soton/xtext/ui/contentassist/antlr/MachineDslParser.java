		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMachineAccess().getExtensionsAssignment_6_2(), "rule__Machine__ExtensionsAssignment_6_2");
					put(grammarAccess.getMachineAccess().getExtensionsAssignment_6_3_1(), "rule__Machine__ExtensionsAssignment_6_3_1");
					put(grammarAccess.getMachineAccess().getVariablesAssignment_7_1(), "rule__Machine__VariablesAssignment_7_1");
					put(grammarAccess.getMachineAccess().getVariablesAssignment_7_2(), "rule__Machine__VariablesAssignment_7_2");
					put(grammarAccess.getMachineAccess().getInvariantsAssignment_8_1(), "rule__Machine__InvariantsAssignment_8_1");
					put(grammarAccess.getMachineAccess().getInvariantsAssignment_8_2(), "rule__Machine__InvariantsAssignment_8_2");
