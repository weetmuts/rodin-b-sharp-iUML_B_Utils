		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatemachineAccess().getGroup_7_2(), "rule__Statemachine__Group_7_2__0");
					...
					put(grammarAccess.getTransitionAccess().getGroup_7_3(), "rule__Transition__Group_7_3__0");
					...
					put(grammarAccess.getTransitionAccess().getGroup_9_3(), "rule__Transition__Group_9_3__0");
					put(grammarAccess.getTransitionAccess().getGroup_10(), "rule__Transition__Group_10__0");
					put(grammarAccess.getTransitionAccess().getGroup_10_3(), "rule__Transition__Group_10_3__0");
					...
					put(grammarAccess.getStatemachineAccess().getTransitionsAssignment_7_2_1(), "rule__Statemachine__TransitionsAssignment_7_2_1");
					...
					put(grammarAccess.getTransitionAccess().getParametersAssignment_7_3_1(), "rule__Transition__ParametersAssignment_7_3_1");
					put(grammarAccess.getTransitionAccess().getGuardsAssignment_8_2(), "rule__Transition__GuardsAssignment_8_2");
					put(grammarAccess.getTransitionAccess().getGuardsAssignment_8_3_1(), "rule__Transition__GuardsAssignment_8_3_1");
					put(grammarAccess.getTransitionAccess().getActionsAssignment_9_2(), "rule__Transition__ActionsAssignment_9_2");
					put(grammarAccess.getTransitionAccess().getActionsAssignment_9_3_1(), "rule__Transition__ActionsAssignment_9_3_1");
					put(grammarAccess.getTransitionAccess().getWitnessesAssignment_10_2(), "rule__Transition__WitnessesAssignment_10_2");
					put(grammarAccess.getTransitionAccess().getWitnessesAssignment_10_3_1(), "rule__Transition__WitnessesAssignment_10_3_1");
					...
					put(grammarAccess.getStateAccess().getStatemachinesAssignment_4_3_1(), "rule__State__StatemachinesAssignment_4_3_1");
					put(grammarAccess.getStateAccess().getInvariantsAssignment_5_2(), "rule__State__InvariantsAssignment_5_2");
					put(grammarAccess.getStateAccess().getInvariantsAssignment_5_3_1(), "rule__State__InvariantsAssignment_5_3_1");
