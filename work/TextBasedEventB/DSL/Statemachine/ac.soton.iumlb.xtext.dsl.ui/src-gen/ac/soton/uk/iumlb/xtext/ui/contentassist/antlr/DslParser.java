		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTransitionAccess().getExtendedAssignment_0(), "rule__Transition__ExtendedAssignment_0");
					put(grammarAccess.getTransitionAccess().getCommentAssignment_2_1(), "rule__Transition__CommentAssignment_2_1");
					put(grammarAccess.getTransitionAccess().getElaboratesAssignment_3_1(), "rule__Transition__ElaboratesAssignment_3_1");
					put(grammarAccess.getTransitionAccess().getElaboratesAssignment_3_2_1(), "rule__Transition__ElaboratesAssignment_3_2_1");
					put(grammarAccess.getTransitionAccess().getTargetAssignment_5(), "rule__Transition__TargetAssignment_5");
					put(grammarAccess.getTransitionAccess().getSourceAssignment_7(), "rule__Transition__SourceAssignment_7");
