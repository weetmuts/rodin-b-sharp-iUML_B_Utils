 ...
 * @generated
 */
public class StatemachineXTextSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public StatemachineXTextSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StatemachineXTextPackage.ABSTRACT_NODE: {
			...
			case StatemachineXTextPackage.JOIN: {
				...
				if (result == null) result = caseAbstractNode(join);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
