...
public class CopyOfStateMachineProcessor {

	private static CopyOfStateMachineProcessor singleton = null;

	public static CopyOfStateMachineProcessor getDefault() {
		if (singleton == null) {
			singleton = new CopyOfStateMachineProcessor();
			return singleton;
		} else {
			return singleton;
		}
	...
	public Call translateStateMachine(EventBElement source,
