/**
 */
package ac.soton.eventb.decomposition.util;

import ac.soton.eventb.decomposition.*;
 ...
 * <!-- end-user-doc -->
 * @see ac.soton.eventb.decomposition.DecompositionPackage
 * @generated
 */
public class DecompositionSwitch<T> {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected static DecompositionPackage modelPackage;
	 ...
	 * @generated
	 */
	public DecompositionSwitch() {
		if (modelPackage == null) {
			modelPackage = DecompositionPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DecompositionPackage.REGION: {
				...
				if (result == null) result = caseEventBElement(region);
				if (result == null) result = caseEventBCommented(region);
				if (result == null) result = caseEventBObject(region);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
